      ...
      ****************************************************************
       01  W-MENU-DATEEMB-INPUT.
           05  W-MENU-DATEEMB-DEBUT-EDITE       PIC 9999/99/99
                                                 VALUE 00000000.
           05  W-MENU-DATEEMB-FIN-EDITE         PIC 9999/99/99
                                                 VALUE 00000000.
           05  W-MENU-DATEEMB-DEBUT             PIC 9(8)
                                                 VALUE 00000000.
           05  W-MENU-DATEEMB-FIN               PIC 9(8)
                                                 VALUE 00000000.
      ***************************************************************
      ...
      ****************************************************************
       ...
       01 MENU-DATEEMB.
           ...
           05 MENU-DATEEMB-INPUT11  LINE 8 COL 35
               PIC 9999/99/99 USING W-MENU-DATEEMB-DEBUT-EDITE.
           05 MENU-DATEEMB-INPUT22  LINE 9 COL 35
               PIC 9999/99/99 USING W-MENU-DATEEMB-FIN-EDITE.
      ...
      *****************************************************************
       50000-MENU-NOM.
           ...
           MOVE W-MENU-NOM-DEBUT TO EMPL-NOM-PRENOM
           START FICHIER-IDX KEY >= EMPL-NOM-PRENOM.

           PERFORM 70000-RECHERCHE
               UNTIL W-IND-FIN-RECHERCHE = 1
                OR EMPL-NOM-PRENOM > W-MENU-NOM-FIN.
      ...
      *****************************************************************
       60000-MENU-DATEEMB.
           MOVE 00000000 TO W-MENU-DATEEMB-DEBUT-EDITE.
           MOVE 00000000 TO W-MENU-DATEEMB-FIN-EDITE.
           ...
           ACCEPT W-MENU-DATEEMB-DEBUT-EDITE AT 0835.
           ACCEPT W-MENU-DATEEMB-FIN-EDITE AT 0935.

           MOVE W-MENU-DATEEMB-DEBUT-EDITE TO W-MENU-DATEEMB-DEBUT.
           MOVE W-MENU-DATEEMB-FIN-EDITE TO W-MENU-DATEEMB-FIN.

           EVALUATE TRUE
             WHEN W-MENU-DATEEMB-DEBUT <> 00000000
               AND W-MENU-DATEEMB-FIN = 00000000
                   MOVE FUNCTION CURRENT-DATE(1:8) TO W-MENU-DATEEMB-FIN
           ...
           PERFORM 70000-RECHERCHE
               UNTIL W-IND-FIN-RECHERCHE = 1
               OR EMPL-DATEEMB > W-MENU-DATEEMB-FIN.
